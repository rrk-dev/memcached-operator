...
import (
	...
	cachev1alpha1 "github.com/rrk-dev/memcached-operator/api/v1alpha1"
)
...
func (r *MemcachedReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	if err != nil {
		if errors.IsNotFound(err) {
			...
			fmt.Printf("Memcached resource not found. Ignoring since object must be deleted")
	...
	if err != nil && errors.IsNotFound(err) {
		...
		fmt.Printf("Creating a new Deployment", "Deployment.Namespace", dep.Namespace, "Deployment.Name", dep.Name)
	...
	if err = r.List(ctx, podList, listOpts...); err != nil {
		fmt.Println(err, "Failed to list pods", "Memcached.Namespace", memcached.Namespace, "Memcached.Name", memcached.Name)
		return ctrl.Result{}, err
	}
